...
where d.DeviceTypeID= 132 and ParentDevID ={0} order by LastPollingTime desc", ParentDevID);
            DataTable dt = null;
            int returnC = 0; try
            {
                dt = db.ExecuteQuery(sql, pageCrrent, pageSize, out returnC);
...
where d.DeviceTypeID= 133 and ParentDevID ={0} order by Process", ParentDevID);
            DataTable dt = null;
            int returnC = 0; try
            {
                dt = db.ExecuteQuery(sql, pageCrrent, pageSize, out returnC);
...
where d.DeviceTypeID= 143 and ParentDevID ={0} order by DiskName", ParentDevID);
            DataTable dt = null;
            int returnC = 0; try
            {
                dt = db.ExecuteQuery(sql, pageCrrent, pageSize, out returnC);
...
where d.DeviceTypeID= 134 and ParentDevID ={0} order by PageSpace", ParentDevID);
            DataTable dt = null;
            int returnC = 0; try
            {
                dt = db.ExecuteQuery(sql, pageCrrent, pageSize, out returnC);
...
where d.DeviceTypeID= 135 and ParentDevID ={0} order by Equipment", ParentDevID);
            DataTable dt = null;
            int returnC = 0; try
            {
                dt = db.ExecuteQuery(sql, pageCrrent, pageSize, out returnC);
        ...
        {
            string sql = string.Format(@"select PortName.MonitorValue PortName,HealthStatus.MonitorValue HealthStatus,
...
where d.DeviceTypeID= 145 and ParentDevID ={0} order by PortName", ParentDevID);
            DataTable dt = null;
            int returnC = 0; try
            {
                dt = db.ExecuteQuery(sql, pageCrrent, pageSize, out returnC);
        ...
        {
            string sql = string.Format(@"select DisplayName.MonitorValue DisplayName,ServiceName.MonitorValue ServiceName,
...
where d.DeviceTypeID= 137 and ParentDevID ={0} order by DisplayName", ParentDevID);
            DataTable dt = null;
            int returnC = 0; try
            {
                dt = db.ExecuteQuery(sql, pageCrrent, pageSize, out returnC);
        ...
        {
            string sql = string.Format(@"select RuleName.MonitorValue RuleName,LogFileType.MonitorValue LogFileType,
...
where d.DeviceTypeID= 136 and ParentDevID ={0} order by RuleName", ParentDevID);
            DataTable dt = null;
            int returnC = 0; try
            {
                dt = db.ExecuteQuery(sql, pageCrrent, pageSize, out returnC);
