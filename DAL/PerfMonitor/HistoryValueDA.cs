...
and MonitorTime> '{3}' and MonitorTime< '{4}'  order by [Time]", tableName, ChannelNo, DeviceID, StartTime.ToString("yyyy-MM-dd HH:mm:ss"), EndTime.ToString("yyyy-MM-dd HH:mm:ss"));
