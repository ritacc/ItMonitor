<%@ Page Title="" Language="C#" MasterPageFile="~/Main/SiteMain.Master" AutoEventWireup="true" CodeBehind="AlarmPolicyManagementList.aspx.cs" Inherits="GDK.BCM.AlertAdmin.AlarmPolicyManagementList" %>
...
<style type="text/css">
    ...
    <script type="text/javascript">
        ...
        function ChageFromUrl(strGUID, DeviceTypeID) {
            ...
            var toUrl = "AlarmPolicyManagementMain.aspx?DeviceID=" + strGUID + "&StationID="
