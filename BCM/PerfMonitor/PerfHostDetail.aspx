<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerfHostDetail.aspx.cs" Inherits="GDK.BCM.PerfMonitor.PerfHostDetail" %>
...
<body>
    ...
    <div class="div_box Padding_5" style="height:270px;">
        ...
        <object data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="300px" height="200px">
            ...
            <param name="initParams" value="Target=MeterHalf,DeviceID=<%= deviceID %>,ChanncelNo=14101" />
        ...
        <object data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="300px" height="200px">
            ...
            <param name="background" value="white" />
            <!--MeterMember MeterAll MeterHalf MeterTemperature-->
            <param name="initParams" value="Target=MeterHalf,DeviceID=<%= deviceID %>,ChanncelNo=14201" />
            <param name="minRuntimeVersion" value="4.0.50826.0" />
            <param name="autoUpgrade" value="true" />
            <a href="../SLFile/Silverlight.zip" style="text-decoration: none">
                <img src="../SLFile/SLMedallion_CHS.png" alt="获取 Microsoft Silverlight" style="border-style: none" />
        ...
        <div class="div_char">
         <div class="div_title">磁盘使用率</div>
        <object data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="300px" height="200px">
            <param name="source" value="../ClientBin/ITMonitorControl.xap" />
            <param name="onError" value="onSilverlightError" />
            <param name="background" value="white" />
            <!--MeterMember MeterAll MeterHalf MeterTemperature-->
            <param name="initParams" value="Target=MeterHalf,DeviceID=<%= deviceID %>,ChanncelNo=14302" />
            <param name="minRuntimeVersion" value="4.0.50826.0" />
            <param name="autoUpgrade" value="true" />
            <a href="../SLFile/Silverlight.zip" style="text-decoration: none">
                <img src="../SLFile/SLMedallion_CHS.png" alt="获取 Microsoft Silverlight" style="border-style: none" />
    ...
    <div class="div_box Padding_5">
      ...
      <div class="div_box Padding_5" id="divNetworkPort" runat="server">
        ...
        <asp:GridView ID="gvNetworkPort" runat="server" AutoGenerateColumns="false" CssClass="gridview_skin">
            <Columns>
                ...
                <asp:BoundField HeaderText="输出流量（kbps）" DataField="OutputFlow" />
                <asp:BoundField HeaderText="错误" DataField="Error" />
            </Columns>
            <EmptyDataTemplate>
                <table cellpadding="0" cellspacing="0" width="100%" class="gridheader_table">
                    <tr class="gridview_skin_header">
        ...
        <uc1:pagenavigate ID="pgNetworkPort" runat="server" />   
     </div>
          
      <div class="div_box Padding_5" id="divServiceDetail" runat="server">
        ...
        <uc1:pagenavigate ID="pgServiceDetail" runat="server" />   
     </div>
          
      <div class="div_box Padding_5" id="divEvent" runat="server">
        ...
        <asp:GridView ID="gvEvent" runat="server" AutoGenerateColumns="false" CssClass="gridview_skin">
            <Columns>
                ...
                <asp:BoundField HeaderText="类型" DataField="EventType" />
                <asp:BoundField HeaderText="用户名" DataField="UserName" />
                <asp:BoundField HeaderText="描述" DataField="Describe" />
                <asp:BoundField HeaderText="日志生成时间" DataField="LogGenerationTime" />
            </Columns>
            <EmptyDataTemplate>
                <table cellpadding="0" cellspacing="0" width="100%" class="gridheader_table">
                    <tr class="gridview_skin_header">
        ...
        <uc1:pagenavigate ID="pgEvent" runat="server" />   
     </div>
    </form>
</body>
</html>
