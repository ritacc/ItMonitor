<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerfDB.aspx.cs" Inherits="GDK.BCM.PerfMonitor.PerfDB" %>
            ...
            <asp:GridView ID="gvDataList" AutoGenerateColumns="False" runat="server" class="gridview_skin">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="数据库名称">
                        <ItemTemplate>
                            <a href="PerfDBIndex.aspx?type=perf&id=<%#Eval("DeviceID") %>" target="_parent"><span class="sercers">
