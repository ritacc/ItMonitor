...
{
    public partial class PerfMiddleware : PageBase
    {
        ...
        public void BindGraid()
        {
            ...
            {
                int PageCount = 0;
                this.gvDataList.DataSource = new PerfMiddlewareDA().selectDeviceList(pg.PageIndex, pg.PageSize, out PageCount, mWhere);
