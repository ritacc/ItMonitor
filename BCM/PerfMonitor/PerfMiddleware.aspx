<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerfMiddleware.aspx.cs" Inherits="GDK.BCM.PerfMonitor.PerfMiddleware" %>
        ...
        <div class="overflow_grid">
            ...
            <table class="searchtable" cellspacing="0">
                <tr>
                    ...
                    <td align="right">
                        请选择查询条件:
                        <asp:RadioButton GroupName="shearch" Checked="true" Text="中间件名称" ID="rdbName" runat="server" />
            ...
            <asp:GridView ID="gvDataList" AutoGenerateColumns="False" runat="server" class="gridview_skin">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="中间件名称">
                        <ItemTemplate>
                            <a href="PerfMiddlewareDetail.aspx?id=<%#Eval("DeviceID") %>"><span class="sercers">
                                <%#Eval("DeviceName")%></span></a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField HeaderText="中间件类型" DataField="TypeName" />
                    <asp:TemplateField HeaderText="性能">
                        <ItemTemplate>
                            <img src='../images/Common/stata<%# Eval("performanceVal") %>.gif' alt="设备状态" />
                        </ItemTemplate>
                    </asp:TemplateField>
