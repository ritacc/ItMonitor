<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerfHost.aspx.cs" Inherits="GDK.BCM.PerfMonitor.PerfHost" %>
            ...
            <asp:GridView ID="gvDataList" AutoGenerateColumns="False" runat="server" class="gridview_skin">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="主机名称">
                        <ItemTemplate>
                            <a href="PerfHostDetail.aspx?id=<%#Eval("DeviceID") %>"><span class="sercers">
                    ...
                    <asp:BoundField HeaderText="物理位置" DataField="StationName" />
                </Columns>
            </asp:GridView>
        </div>
